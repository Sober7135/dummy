...
int main(int argc, char **argv) {
    ...
    ASSERT((std::is_same_v<decltype(hello), decltype(std::string{hello})>), "Fill in the missing type.");
    ASSERT((std::is_same_v<decltype(world), decltype(hello.c_str())>), "Fill in the missing type.");
    // TODO: 将 `?` 替换为正确的字符串
