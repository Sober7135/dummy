...
int main(int argc, char **argv) {
    {
        ...
        ASSERT(sizeof(vec) == sizeof(int *) + sizeof(vec.size()) * 2, "Fill in the correct value.");
        int ans[]{1, 2, 3, 4, 5};
    ...
    }
    {
        ...
        }
        {
            ...
            ASSERT(sizeof(vec) == sizeof(double *) + 2 * sizeof(vec.size()), "Fill in the correct value.");
            vec.pop_back();
            ASSERT(vec.size() == 5, "Fill in the correct value.");
            ASSERT(sizeof(vec) == sizeof(double *) + 2 * sizeof(vec.size()), "Fill in the correct value.");
        }
    ...
    }
    {
        ...
        ASSERT(sizeof(vec) == sizeof(char *) + sizeof(size_t) * 2, "Fill in the correct value.");
        {
